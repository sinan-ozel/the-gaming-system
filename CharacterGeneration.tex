...
\begin{wrapfigure}{L}{0.4\textwidth}
	\begin{tikzpicture}
		\coordinate (NW);
		\capabilityTable{Core Capabilities}{
			...
			\coreCapability{Communication}{2d4}
			\coreCapability{Social Awareness}{2d4}
			\coreCapability{Focus}{2d4}
...
Larger dice ($d8$, $d10$, ...) are reserved to go \term{beyond the mundane} - for heroes, superheroes and supernatural characters.
...
% TODO: Put the following explanation in hovers inside the table.
% Humans get +7 to their vision.
% \footnote{
% 	To calculate the vision for an animal, divide their visual acuity, cycles-per-degree by ten.
...
% For instance, this character had myopia in their prescription, so their
% sight is +2.
...
To go \term{beyond the mundane}, you might want to consider these characters.
See the footnote.
\footnote{
	Some of these senses are not well understood, and quantifying them is difficult.
	Furthermore, going \term{beyond the mundane}, there can be other senses,
