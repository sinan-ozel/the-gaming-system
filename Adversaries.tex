...
\sbox{0}{
	\begin{actorCardMiniEuro}{mundaneHazardFire}{Small Fire}{colorBgMundane}
		\capabilityTable{mundaneHazardFire}{Capabilities}{
			\coreCapability{Burn}{1d4}
			\coreCapability{Smother}{1d4}
		}
...
\sbox{0}{
	\begin{actorCardMiniEuro}{mundaneHazardFire}{Raging Inferno}{colorBgMundane}
		\capabilityTable{mundaneHazardFire}{Capabilities}{
			\coreCapability{Heat}{2d20}
			\coreCapability{Smother}{1d20}
		}
	\end{actorCardMiniEuro}
}
...
\sbox{0}{
	\begin{actorCardStandardSize}{mundaneAnimalSquirrel}{Squirrel}{colorBgMundane}
		\capabilityTable{mundaneAnimalSquirrel}{Capabilities}{
			\coreCapability{Situational Awareness}{1d4}
			\coreCapability{Coordination}{2d6}
		}
		\bonusTable{mundaneAnimalSquirrel}{
			\expertiseLine{Gather Nuts}{+3}
			\expertiseLine{Speed (Sprint)}{??}
			\expertiseLine{Speed (Climb)}{??}
		}
