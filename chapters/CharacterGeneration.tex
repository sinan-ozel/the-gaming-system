...
\begin{marginNote}
	...
	In various settings or stories, spells, powers \& overpowered
	\termCore{core capabilities} take the character \term{beyond the ordinary}.
\end{marginNote}
To create the character, we first decide on their life story so far,
...
Now do the same for the teenage years.
...
% You now know everything you need to understand the character sheet in the next page.
% Feel free to jump to the next page to see the character sheet.
% This process differs from many other gaming systems in two respects:
% first, we do not enforce any rules about fairness. Just as in life, some members of the troupe can be more advantaged than the others - this is up to the players to deal with.
% Second, as a player, you do not need to flesh out all of the details of the character to start playing.
% Some parts of their history may be decided after the game starts, and these decisions can
% add new bonuses.
...
% The first die should come from the childhood, second die from teenage years.
\clearpage
...
\begin{actorCardLetterSizeFitToPage}{testCharacter}{Sample Mundane Adult}{colorBgMundane}
...
% \section{Go Beyond the Ordinary - Other Humanoid Species}



% \section{Go Beyond the Ordinary - Vampires}
