...
% TODO: Add a link to the beyond-the-mundane calculation.
...
\begin{tikzpicture}[overlay]
	\node[draw, fill=LightYellow, thick,minimum width=5cm,minimum height=3cm] (b) at (-3.5,-2){
		Annotations are coming.
	};
\end{tikzpicture}
