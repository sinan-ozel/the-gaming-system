...
% TODO: Recreate the character sheet based on the following categorization:
% Physical / Mental / Innate
% Transpose the top table.

% Alternative: Physical / Mental / Intellectual / Innate & Social
% Mental are the things that involve focus & concentration, and do not result in physical exertion.

% Add the main formula on top of the character sheet.
...
% \begin{actorCardLetterSizeFitToPage}{testCharacter}{Test Human}{colorBgMundane}
% 	\begin{topTableCBP}{testCharacter}
% 		\physicalCBP{
% 			\coreCapability{Coordination}{2d4}
% 			\coreCapability{Constitution}{d4+d6}
% 		}{
% 			\bonusLine{Core Strength}{+1}
% 			\bonusLine{Upper Body}{+1}
% 		}{
% 			\propertyLine{Armor}{1}
% 			\propertyLine{Size}{?}
% 			\propertyLine{Trauma Scale}{?}
% 		}
% 		\mentalCBP{
% 			\coreCapability{Reasoning}{2d6}
% 			\coreCapability{Situational Awareness}{d4+d6}
% 			\coreCapability{Focus}{2d6}
% 			\coreCapability{Willpower}{2d4}
% 		}{
% 			\bonusLine{Vision}{+7}
% 			\bonusLine{Hearing}{+1}
% 		}{}
% 		\socialCBP{
% 			\coreCapability{Communication}{2d6}
% 			\coreCapability{Creativity}{2d4}
% 			\coreCapability{Social Awareness}{d4+d6}
% 		}{}{}
% 	\end{topTableCBP}

% 	\expertiseTable{testCharacter}{
%         \expertiseLine{Accounting}{+1}
%         \expertiseLine{Chemistry}{+1}
%         \expertiseLine{Computing Concepts}{+10}
%         \expertiseLine{Economics}{+2}
%         \expertiseLine{Electrical Engineering}{+6}
%         \expertiseLine{Finance}{+2}
%         \expertiseLine{Marketing}{+1}
%         \expertiseLine{Physics}{+1}
% 	}{
%         \expertiseLine{Cycling}{+3}
%         \expertiseLine{Dancing (Latin)}{+3}
%         \expertiseLine{Driving (Car)}{+3}
%         \expertiseLine{Swimming}{+3}
% 	}{
%         \expertiseLine{Skepticism}{+4}
% 	}
% \end{actorCardLetterSizeFitToPage}
...
\begin{center}
	\begin{xltabular}{\textwidth}{XXXl}
		...
		\hline
		\footnotesize \listUniversalKnowledge	&\footnotesize \listUniversalTraining	& \footnotesize \listTalents 	 		& \sideTab{colorBgMundane}{All Settings} \\
		\footnotesize \listModernKnowledge		&\footnotesize \listModernTraining		& \footnotesize \listModernTalents		& \sideTab{colorBgModern}{Modern Setting} \\
		\footnotesize \listMedievalKnowledge	&\footnotesize \listMedievalTraining	& \footnotesize  						& \sideTab{colorBgMedieval}{Medieval Setting} \\
		\footnotesize \listFantasyKnowledge		&\footnotesize \listFantasyTraining		& \footnotesize  \listFantasyTalents 	& \sideTab{colorBgBeyondMundane}{Beyond the Mundane} \\
	\end{xltabular}
\end{center}
