...
\section*{Generate a \term{Mundane} Character}
\begin{marginNote}
...
You thought about their background, so represent your character to the best of your knowledge:
\begin{enumerate}
...
add their set \termBonus{bonuses} from their species, either \term{physiology} or their \term{expertise}, whichever is higher.
...
\marginpar{
	\begin{mdframed}[style=d20ComparisonBoxStyle,frametitle=Compare to $d20$]
		\footnotesize
		Imagine \termCore{core capabilities} as dice rolls that replace the $d20$ roll.
	\end{mdframed}
}
