...
Generating a character like writing a social network profile or a CV: Based on the character idea, formulate their \term{core competencies}.
...
\term{Core competencies} determine which dice to roll \& add to overcome challenges.
\marginpar{
	\footnotesize
	For d20 players:
	imagine \term{core competencies} as the dice roll that replaces the d20 rolls.
}
...
\begin{center}
	...
	\resizebox{\columnwidth}{!}{
		\begin{tabular}{lr|lr|lr|}
			...
			\multicolumn{6}{c}{} \\
 			\multicolumn{2}{c}{Resources}	&	\multicolumn{2}{c}{Physiological}&	\multicolumn{2}{c}{Items} \\
			\hline
			Passive Income & +1				& Sight	& +2				&  Mobile Phone & \\
			Renown & 						& Hearing &	+2				&  & \\
